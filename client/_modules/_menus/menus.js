    ...
    $('input#dropdownHam').click(function(e) {
        if (dropdownHam == 0) {
            ...
            $("#menuFull").animate({
                ...
                $("#btnHam").addClass('opened'); $('#navigation').fadeIn(500);
            });
            dropdownHam = 1;
        } else {
            ...
            $('#navigation').fadeOut(500, function() {
                $("#btnHam").removeClass('opened'); $("#main").removeClass('overlay-open'); $("#menuFull").animate({
                    width: 'toggle'
                }, 500, "swing");
            });
            dropdownHam = 0;
...
function scrollToAnchor($this) {
    ...
    $('html,body').animate({
        scrollTop: aTag.offset().top - offsetHeader
    }, 1000);
